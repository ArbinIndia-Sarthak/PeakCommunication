            ...
            if (cleanLine.StartsWith(PropertiesDefinitionLineStarter))
            {
                ...
                if (match.Success)
                {
                    ...
                    else if (match.Groups[IsIntegerValueGroup].Value.Equals("HEX"))
                    {
                        ...
                        customProperty.HexCustomProperty = new NumericCustomPropertyDefinition<double>
                        {
                            Minimum = Convert.ToDouble(match.Groups[MinIntGroup].Value, CultureInfo.InvariantCulture),
                            Maximum = Convert.ToDouble(match.Groups[MaxIntGroup].Value, CultureInfo.InvariantCulture),
                        };
                    }
